...
.. note::
   ...
   ``MP4Trimming`` 기능이 ``ON`` 이라면 Trimming된 MP4을 HLS로 변환할 수 있다. (HLS영상을 Trimming할 수 없다. HLS는 MP4가 아니라 MPEG2TS 임에 주의하자.)
...
그렇지 않다면 서비스 규모에 맞게 물리적인 CPU자원이 충분히 확보하는 것이 바람직하다.
